                ...
                <tbody>
                    @foreach($data as $grp)
                        <tr scope="row">
                            ...
                            <td><a href="/projects/{{$grp->groupNo}}" class="btn btn-warning" title="{{$grp->projName}}" data-toggle="popover" data-content="View project details" data-placement="top"><span><i class="fas fa-project-diagram"></i></span> {{(substr($grp->projName, 0, 10) . '..')}}</a></td>
