        ...
        <h4><span class="alert bg2 f-title1">MANAGE STAGE SETTINGS</span></h4>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form id="form-search" method="post" action="/stage-search-results" accept-charset="UTF-8" role="search">
                        {{csrf_field()}} 
                        <div class="input-group">
                        <input type="text" class="form-control search-bar1" name="q" placeholder="Search Stages" list="stage1">           
                        <?php 
